...
<head>
    ...
    <link rel="icon" href="{{ $setting?->faviconImage ?? asset('favicon.ico') }}" type="image/x-icon" />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="footerWidget web-icon">
                                    <img src="{{ asset('assets/images/footer-logo-img.png') }}" alt="footer-logo" class="fadlo">
                                    <br><br>
                    ...
                    <div class="col-sm-3">
                        <div class="footerForm">
                            <form action="/contact" method="POST" class="footerContact">
                                @csrf
                                <h5><img src="{{ asset('assets/images/message-icon.png') }}" alt="message-icon"> Quick Contact Form</h5>
