<template>
<div class="privacy-policy container mx-auto p-6 text-gray-800">
<HeaderSection />
<div class="privacy-policy-head text-center">
    <h1 class="text-3xl font-bold mb-4">Our Privacy Policy</h1>
    <p class="mb-4">
...
<li>We may use the information to customize the website according to your interests.</li>
    ...
    <h3 class="text-xl font-semibold mt-6 mb-2">SECURITY</h3>
<p class="mb-4">
